...
public class MonitoringService {
	...
	public static String connect(@Payload String input) throws HttpException, IOException {
		...
		login();
		create_host("10.1.90.58");  // assume that the ip is the host name 
		get_host("10.1.90.58");
	...
	public static void create_host(String ip){
		try{	
	...
	public static void get_host(String ip){
		try{	
			...
			putMethod_gethost.setRequestBody(zabbixapi.get_host(ip,auth)); // the ip is the host name 
