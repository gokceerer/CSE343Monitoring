...
public class zabbixapi {
    ...
    public static InputStream create_item(String app , String key , String hostid , String interfaceid , String[] application , String  delay , String auth){
    ...
    public static InputStream create_item_cpu(String app , String hostid , String interfaceid , String[] application , String  delay , String auth ){
        return create_item(app+" CPU Usage" , "proc.cpu.util["+app+"]" , hostid , interfaceid , application , delay ,auth);
    }

    public static InputStream create_item_mem(String app , String hostid , String interfaceid , String[] application , String  delay , String auth ){
        return create_item(app+" Memory Usage" , "proc.mem["+app+"]" , hostid , interfaceid , application , delay ,auth);
    }

    public static InputStream get_interfaceid (String hostid , String auth){
    ...
    public static InputStream create_graph(String name , String auth , String itemid){
    ...
    public static InputStream creeate_host(String ip , String name, String auth){ // the ip represents the host name here  
       // return create_host(ip,auth,name ,groups("1"),interfaces("127.0.0.1","10050"));
        return fromString(create_host(ip,auth, name, groups("1"),interfaces("127.0.0.1","10050")));
    }
